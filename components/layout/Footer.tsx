    ...
    <footer id="contact" className="bg-slate-900 text-white mt-20">
      <div className="container mx-auto px-6 py-16">
        <div className="grid md:grid-cols-4 gap-10">
          <div>
            <h3 className="text-2xl font-bold mb-5">کد رزرو</h3>
            <p className="text-slate-300 leading-8">
              سامانه رزرو آنلاین نوبت پزشکان و مراکز درمانی.
            </p>
          </div>
          <div>
            <h4 className="font-bold mb-5">لینک‌های سریع</h4>
          ...
          <div>
            <h4 className="font-bold mb-5">تماس با ما</h4>
            <ul className="space-y-3 text-slate-300">
              <li>تهران، ایران</li>
              <li>021-12345678</li>
          ...
          <div>
            <h4 className="font-bold mb-5">شبکه‌های اجتماعی</h4>
